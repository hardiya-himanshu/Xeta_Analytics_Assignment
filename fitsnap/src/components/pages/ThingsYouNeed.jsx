...
function ThingsYouNeed({darkMode}) {
  return (
    <div id='things' className={`max-h-full py-10 ${darkMode?"bg-customDark text-customWhite":"bg-customLight text-customBlack"}`}>
        ...
        <div className='scrollbar-hide relative h-full w-full min-h-[400px] overflow-x-scroll sm:p-0 p-2 sm:border-0 border-2 ${darkMode?"border-customWhite":"border-gray-800"}'>
