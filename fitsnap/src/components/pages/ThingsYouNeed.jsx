...
function ThingsYouNeed({darkMode}) {
  return (
    <div id='things' className={`max-h-full py-10 ${darkMode?"bg-customDark text-customWhite":"bg-customLight text-customBlack"}`}>
        ...
        <div className={`relative h-full w-full min-h-[400px] overflow-x-scroll sm:p-0 p-2 sm:border-0 border-2 ${darkMode?"border-customWhite":"border-gray-800"}`}>
            <img src={'../assets/images/things-bg.png'} alt="Things You Need" className={`max-h-full min-h-[400px] min-w-[600px]  rounded-md  w-full bg-center bg-cover object-cover`} />
